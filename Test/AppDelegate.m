...
#pragma mark--- jspatch
    ...
    MasterViewController *mastVC = [[MasterViewController alloc] init];
    UINavigationController *navigationController = [[UINavigationController alloc] initWithRootViewController:mastVC];
